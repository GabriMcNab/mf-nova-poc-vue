<template>
  <label
    v-if="label"
    :data-testid="`${id}-input-text-label`"
    :for="`${id}-label`"
  ...
  >
    ...
    <span
      v-if="error"
      class="InputText__error-msg"
      :data-testid="`${id}-input-text-error`"
      >{{ error }}</span
    >
    <button
    ...
    <div
      v-if="error || theme === 'error'"
      class="InputText__error-icon"
      data-testid="input-text-error-icon"
    >
    ...
    <div
      ...
      class="InputText__success-icon"
      data-testid="input-text-success-icon"
    >
